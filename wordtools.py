def process_vocabulary(variant_file, cet6_file, output_file, notfound_file):
    """
...
if __name__ == "__main__":
    # 示例用法
    variant_file = "./ECDICT/lemma.en.txt"  # 包含单词变体信息的文件
    cet6_file = "./cet6word.txt"  # 包含CET6词汇表的文件
